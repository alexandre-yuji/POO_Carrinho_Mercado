    ...
    if len(produtos) > 0:
        ...
        if produto:
            if len(carrinho) > 0:
                ...
                item = {produto: 1} # produto que eu peguei pelo código e a quantidade
...
def fechar_pedido() -> None:
    if len(carrinho) > 0:
        ...
        for item in carrinho:
            for dados in item.items():
                print(dados[0]) # chave para o nome do produto
                print(f'Quantidade: {dados[1]}') # chave para a quantidade
